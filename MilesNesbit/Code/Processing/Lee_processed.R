...
Fig_1 <- read.csv("../Data/Lee_et_al_2007/Fig_1.csv",
                  stringsAsFactors = F) %>%
  format_data(.,"","Hours","CFU/g","aerobic bacteria","soybeans",1)
...
#cite
final_df$Citation <- 'Lee, D. S., Hwang, K. J., An, D. S., Park, J. P., & Lee, H. J. (2007). Model on the microbial quality change of seasoned soybean sprouts for on-line shelf life prediction. International Journal of Food Microbiology, 118(3), 285–293. https://doi.org/10.1016/j.ijfoodmicro.2007.07.052'
